...
from model_reward import RewardModel  # type:ignore
...
def main():
    ...
    while step < args.steps :
        ...
        #pad to same length
        policy_ctx = getattr(policy , "blocksize" , block_size)
        ...
        with torch.no_grad():
            ...
            lp_now  = lp_post                         # already computed above on the same position
